...
class Sphere : public Mesh {
   ...
   private:
    static std::vector<Vertex> generateVertices(glm::vec3 center, glm::vec3 color, int latSeg, int lonSeg, float radius) {
    ...
    static std::vector<GLuint> getIndexes(int latSeg, int lonSeg) {
